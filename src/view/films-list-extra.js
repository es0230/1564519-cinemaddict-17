...
const createExtraFilmsListSectionTemplate = () => (
...
export default class ExtraFilmsListSectionView extends AbstractView{
  get template() {
    return createExtraFilmsListSectionTemplate();
  }
}
